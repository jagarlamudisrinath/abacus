...
export default function PracticeSheetEditor({ sheetId, onClose }: PracticeSheetEditorProps) {
  ...
  const handleNameChange = (value: string) => {
    setName(value);
    if (!sheetId && !customId) {
      // Auto-generate ID for new sheets
      setCustomId(generateSlug(value));
    }
  };
        ...
        <section className="metadata-section">
          ...
          <div className="form-group">
            ...
            <input
              ...
              disabled={!!sheetId}
            />
            {!sheetId && <span className="hint">Auto-generated from name, or customize</span>}
          </div>
